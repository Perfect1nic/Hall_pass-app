...
def submit_pass(name, destination):
    ...
    entry = f"{timestamp} - {name} to {destination}"
    pass_history.append(entry)
    print(f"Logged: {entry}") # For debugging
    show_frame(submit_screen, "lightgreen")
...
def create_history_screen(container):
    ...
    label = tk.Label(frame, text="Pass History", font=("Arial", 18), bg="white")
    label.pack(pady=20)
...
def create_bathroom_screen(container):
    ...
    time_entry = tk.Entry(frame, text="", font=("Arial", 12))
    time_entry.pack(pady=10)

    submit_btn = tk.Button(frame, text = "Submit", font=("Arial", 12),
                             command=lambda: [get_text1(), show_frame(submit_screen)])
...
def create_office_screen(container):
    ...
    time_box_office = tk.Label(frame, text="Enter the time", font=("Arial", 15), bg="lightgreen")
    time_box_office.pack(pady=(10, 0))

    time_office = tk.Entry(frame, text="", font=("Arial", 12))
    time_office.pack(pady=10)

    submit_btn = tk.Button(frame, text = "Submit", font=("Arial", 12),
                             command=lambda: [get_text2(), show_frame(submit_screen)])
    submit_btn.pack(pady=10)
    return frame
...
def create_nurse_screen(container):
    ...
    time_box_nurse = tk.Label(frame, text="Enter the time", font=("Arial", 15), bg="lightcoral")
    time_box_nurse.pack(pady=(10, 0))

    time_nurse = tk.Entry(frame, text="", font=("Arial", 12))
    time_nurse.pack(pady=10)

    submit_btn = tk.Button(frame, text = "Submit", font=("Arial", 12),
                             command=lambda: [get_text3(),show_frame(submit_screen)])
    submit_btn.pack(pady=10)
    return frame
...
def create_classroom_screen(container):
    ...
    time_box_classroom = tk.Label(frame, text="Enter the time", font=("Arial", 15), bg="beige")
    time_box_classroom.pack(pady=(10, 0))

    time_classroom = tk.Entry(frame, text="", font=("Arial", 12))
    time_classroom.pack(pady=10)

    submit_btn = tk.Button(frame, text = "Submit", font=("Arial", 12),
                             command=lambda: [get_text4(),show_frame(submit_screen)])
    submit_btn.pack(pady=10)
    return frame
